...
<style>
  ...
  .run-head{
    ...
    text-align:center; background:#f4ecd2;
  ...
  /* ---- Bara xwendinê (jêrîn): bookmark + rûpel ---- */
  .reader-bar{
    position:fixed; bottom:0; left:0; right:0; z-index:60;
    display:flex; gap:7px 9px; align-items:center; justify-content:center; flex-wrap:wrap;
    background:#efe5c8; border-top:0.6px solid #2a241b; padding:5px 9px;
  ...
  .reader-bar .rb-group .rb-az{ font-style:italic; }
  ...
  @media screen{
    body{ background:#d9ccac; padding:62px 0 58px; font-size:17px; }
    .flow, .cover-host{
...
<div class="reader-bar">
  <span class="rb-item">Rûpel (PDF): <b id="curpage">&mdash;</b></span>
...
(function(){
  ...
  function refresh(){ if(curEl) curEl.textContent = currentPage(); }
